...
public class ReservationStatusViewHandler {
    ...
    public void whenCheckInInfoRegistered_then_CREATE_1(
        ...
        try {
            ...
            reservationStatus.setCheckInTime(
                Date.valueOf(checkInInfoRegistered.getCheckInTime())
            );
            // view 레파지 토리에 save
    ...
    public void whenCheckoutInfoRegistered_then_CREATE_2(
        ...
        try {
            ...
            reservationStatus.setCheckOutTime(
                Date.valueOf(checkoutInfoRegistered.getCheckOutTime())
            );
            // view 레파지 토리에 save
            reservationStatusRepository.save(reservationStatus);
        } catch (Exception e) {
